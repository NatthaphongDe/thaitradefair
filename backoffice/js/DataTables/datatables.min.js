 ...
 *   https://datatables.net/download/#bs-3.3.7/jq-2.2.4/dt-1.10.13/af-2.1.3/cr-1.3.2/fh-3.1.2/kt-2.2.0/r-2.1.1/rr-1.2.0/sc-1.4.2/se-1.2.0
 *
 * Included libraries:
 *   Bootstrap 3.3.7, jQuery 2.2.4, DataTables 1.10.13, AutoFill 2.1.3, ColReorder 1.3.2, FixedHeader 3.1.2, KeyTable 2.2.0, Responsive 2.1.1, RowReorder 1.2.0, Scroller 1.4.2, Select 1.2.0
 */
...
aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null};m.ext=x={buttons:{},classes:{},build:"bs-3.3.7/jq-2.2.4/dt-1.10.13/af-2.1.3/cr-1.3.2/fh-3.1.2/kt-2.2.0/r-2.1.1/rr-1.2.0/sc-1.4.2/se-1.2.0",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:m.fnVersionCheck,iApiIndex:0,oJUIClasses:{},sVersion:m.version};h.extend(x,{afnFiltering:x.search,aTypes:x.type.detect,ofnSearch:x.type.search,oSort:x.type.order,afnSortData:x.order,aoFeatures:x.feature,
