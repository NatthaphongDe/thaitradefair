...
if($_REQUEST["method"]=="add") {
  ...
  $sql = "insert into tt_why_content (why_date,why_detail,why_status,why_create_date,why_create_by,why_update_date,why_update_by,why_title) values (?,?,'1',now(),?,now(),?,?) ";
  $stmt = $mysqli->prepare($sql);
  if($stmt) {
    $stmt->bind_param('ssiis',$why_date,$why_detail,$adminid,$adminid,$why_title);
    $stmt->execute();
              ...
              <div class="row">
                ...
                <div class="col-xs-3">
                  <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      <iframe src="php/cms_photo.php?pid=1" frameborder="0" width="100%" height="500" style="overflow-x:hidden; overflow-y:auto"></iframe>
                    </div>
                  </div>
                </div>
