...
function changeStatus() {
  ...
  $.ajax({
      type: "GET",
      url: "php/adfair_information.php?method=chgstatus&status="+st,
      dataType: "text",
...
function changeStatusMap() {
  ...
  $.ajax({
      type: "GET",
      url: "php/adfair_information.php?method=chgstatusmap&status="+st,
      dataType: "text",
      success : function(data) {
        $('.sm_').empty();
        $('.sm_').html(data);
...
function changeTypeCMSAction(id) {
  $.ajax({
      type: "GET",
      url: "php/adfair_information.php?method=chnagetpye&type="+id+'&fair_id=<?=$fair_id?>&fct_id=<?=$fct_id?>',
      dataType: "text",
      success : function(data) {
...
function changePublish() {
  ...
  $.ajax({
      type: "GET",
      url: "php/adfair_information.php?method=chgpublish&status="+st,
      dataType: "text",
      success : function(data) {
        $('._pp').empty();
        $('._pp').html(data);
