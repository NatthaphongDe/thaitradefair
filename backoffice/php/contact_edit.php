<?php
$menu_name = "Message";
$save_link = "contact_edit";
$back_link = "contact_list";
$reply_link = "contact_reply_link";
$con_id = $_GET['cont_id'];
$num_v = "1";
...
if($_REQUEST["method"]=="add") {
  ...
  $sql_del = "update tt_contact_list set cont_status = ? where cont_id = ? ";
...
$sql_view = "update tt_contact_list set cont_status = ? where cont_id = ? ";
...
$sql = "select * from  tt_contact_list where cont_id = ? and fair_id = 0 and cont_status != 99 ";
                  ...
                  <div class="col-sm-12">
                    <div class="list-group-item">
                        <div class="row">
                            ...
                            <?php  if($numrow_check == 0) { ?>
                            <a href="home.php?show=contact_reply_link&cont_id=<?=$data["cont_id"]?>" class="btn btn-default"><span class="glyphicon glyphicon-share-alt"></span> Reply</a></div>
                            <?php } else { ?>
