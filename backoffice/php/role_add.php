...
if($_REQUEST["method"]=="add") {
  ...
  $sql = "insert into tt_admin_role (role_lv,role_name,role_status,role_create_date,role_create_by,role_update_date,role_update_by,role_flag) values (?,?,?,now(),?,now(),?,'0') ";
  $stmt = $mysqli->prepare($sql);
  if($stmt) {
    $stmt->bind_param('isiii',$role_lv,$role_name,$role_status,$adminid,$adminid);
    $stmt->execute();
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" class="form-control" name="role_name" required autocomplete="off" />
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <div class="radio radio-info radio-inline">
                          <input type="radio" id="inlineRadio1" value="1" name="role_status" checked required >
                          <label for="inlineRadio1"> Active</label>
                      </div>
                      <div class="radio radio-info radio-inline">
                          <input type="radio" id="inlineRadio2" value="2" name="role_status" required >
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <div class="radio radio-info radio-inline">
                          <input type="radio" id="inlineRadio1x" value="1" name="role_lv" checked required onclick="changeRole(1);" >
                          <label for="inlineRadio1x"> Super Admin</label>
                      </div>
                      <div class="radio radio-info radio-inline">
                          <input type="radio" id="inlineRadio2x" value="2" name="role_lv" required onclick="changeRole(2);">
                          <label for="inlineRadio2x"> Admin</label>
                      </div>
                      <div class="radio radio-info radio-inline">
                          <input type="radio" id="inlineRadio3x" value="3" name="role_lv" required onclick="changeRole(3);">
                          ...
                          while($datac = $resultc->fetch_assoc()) {
                            ...
                            <tr style="background:#F7F7F8 !important;">
                              <td class="text-left vmiddle" style="color:#1C5FA1;">
                                ...
                                <input type="hidden" id="page_id_<?=$datac["page_id"]?>" name="page_status[<?=$runno?>]" value="1">
                              </td>
                              ...
                              <td class="text-center vmiddle">
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" class="_req" id="inlineRadio1x_<?=$datac["page_id"]?>" value="1" name="page_permission[<?=$runno?>]" required >
                                    <label for="inlineRadio1x_<?=$datac["page_id"]?>"> Read Only</label>
                                </div>
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" class="_req" id="inlineRadio2x_<?=$datac["page_id"]?>" value="2" name="page_permission[<?=$runno?>]" checked required >
                            ...
                            <tr>
                              <td class="text-left vmiddle" style="padding-left:20px;">
                                ...
                                <input type="hidden" id="page_id_<?=$datac2["page_id"]?>" name="page_status[<?=$runno?>]" value="1">
                              </td>
                              <td class="text-center vmiddle">
                              ...
                              <td class="text-center vmiddle">
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" class="inlineRadioM1_<?=$datac["page_id"]?> _req" id="inlineRadio1x_<?=$datac2["page_id"]?>" value="1" name="page_permission[<?=$runno?>]"  required >
                                    <label for="inlineRadio1x_<?=$datac2["page_id"]?>"> Read Only</label>
                                </div>
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" class="inlineRadioM2_<?=$datac["page_id"]?> _req" id="inlineRadio2x_<?=$datac2["page_id"]?>" value="2" name="page_permission[<?=$runno?>]" checked required >
