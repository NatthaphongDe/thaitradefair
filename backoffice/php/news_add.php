...
if($_REQUEST["method"]=="add") {
  ...
  if($stmt) {
    $stmt->bind_param('iiisiiissssssiisissss',$fair_id,$fct_id,$fcat_id,$fca_date,$fca_status,$adminid,$adminid,$fca_title_th,$fca_title_en,$fca_detail_th,$fca_detail_en,$fc_url,$fc_youtube,$fca_pubish,$fca_tag_fair_id,$fca_tag_master_id,$fca_map_status,$fca_map_title,$fca_lat,$fca_lng,$fca_address,$pid);
    $stmt->execute();
...
function changeStatus() {
  ...
  $.ajax({
      type: "GET",
      url: "php/news_add.php?method=chgstatus&status="+st,
      dataType: "text",
...
function changePublish() {
  ...
  $.ajax({
      type: "GET",
      url: "php/news_add.php?method=chgpublish&status="+st,
      dataType: "text",
      success : function(data) {
        $('._pp').empty();
        $('._pp').html(data);
...
function changeStatusMap() {
  ...
  $.ajax({
      type: "GET",
      url: "php/news_add.php?method=chgstatusmap&status="+st,
      dataType: "text",
      success : function(data) {
        $('.sm_').empty();
        $('.sm_').html(data);
...
function changeSeleteFair(id) {
  ...
  $.ajax({
      type: "GET",
      url: "php/news_add.php?method=changefair&gid="+id,
      dataType: "text",
      success : function(data) {
        $('._fairdiv').html(data);
      }
