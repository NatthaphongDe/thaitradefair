  ...
  if($stmt) {
    ...
    if($numrow>0) {
      ...
      <script type="text/javascript">
        setTimeout(function () {top.window.location="../home.php?show=adfair_token&fair_id=<?=$fair_id?>";},500);
      </script>
      <?php
      exit();
    } else {
...
$fair_id = $_GET["id"];
?>
<form class="form-horizontal" method="post" name="form_Suppliers_add" enctype="multipart/form-data" id="form_Suppliers_add" action="php/adfair_token_pass.php?method=add" target="com_m" onSubmit="pc_overlay(1);" >
