       ...
       <ol class="breadcrumb">
           <li>
            ...
            <div class="div-right text-right">
              ...
              &nbsp;&nbsp;&nbsp;
              <a href="home.php?show=fair_content_aricle_add&fair_id=<?=$fair_id?>&fct_id=<?=$fct_id?>" class="btn btn-success">+ Add <?=$menu_head?></a>
                        ...
                        while($data = $result->fetch_assoc()) {
                          ...
                          <tr>
                            ...
                            <td class="text-center vmiddle">
                              ...
                              <span><img id="e_<?=$data["fca_id"]?>" onmouseover="actionOver('e_<?=$data["fca_id"]?>','1');" onmouseout="actionOut('e_<?=$data["fca_id"]?>','1')" src="../backoffice/asset/icon_edit_null.png" height="35" onclick="window.location='home.php?show=fair_content_aricle_edit&id=<?=$data["fca_id"]?>&fair_id=<?=$data["fair_id"]?>&fct_id=<?=$data["fct_id"]?>';" ></span>
                              &nbsp;
...
function changeStatus(id,type) {
  $.ajax({
      type: "GET",
      url: "php/fair_content_aricle.php?method=chgstatus&id="+id+"&status="+type,
      dataType: "text",
...
function confirmDeleteAction(id) {
  $.ajax({
      type: "GET",
      url: "php/fair_content_aricle.php?method=delete&id="+id+'&fair_id=<?=$fair_id?>&fct_id=<?=$fct_id?>',
      dataType: "text",
      success : function(data) {
...
function changeTypeCMSAction(id) {
  $.ajax({
      type: "GET",
      url: "php/fair_content_aricle.php?method=chnagetpye&type="+id+'&fair_id=<?=$fair_id?>&fct_id=<?=$fct_id?>',
      dataType: "text",
      success : function(data) {
        setTimeout(function () {top.window.location="home.php?show=fair_content_portal&fair_id=<?=$fair_id?>&fct_id=<?=$fct_id?>";},100);
      }
