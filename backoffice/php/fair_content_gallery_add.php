<?php
$save_link = "fair_content_gallery_add";
...
function changeStatus() {
  ...
  $.ajax({
      type: "GET",
      url: "php/fair_content_gallery_add.php?method=chgstatus&status="+st,
      dataType: "text",
...
function changePublish() {
  ...
  $.ajax({
      type: "GET",
      url: "php/fair_content_gallery_add.php?method=chgpublish&status="+st,
      dataType: "text",
      success : function(data) {
        $('._pp').empty();
        $('._pp').html(data);
