<?php
$save_link = "admin_fair_content_aricle_add";
...
function changeStatus() {
  ...
  $.ajax({
      type: "GET",
      url: "php/admin_fair_content_aricle_add.php?method=chgstatus&status="+st,
      dataType: "text",
...
function changePublish() {
  ...
  $.ajax({
      type: "GET",
      url: "php/admin_fair_content_aricle_add.php?method=chgpublish&status="+st,
      dataType: "text",
      success : function(data) {
        $('._pp').empty();
        $('._pp').html(data);
...
function changeStatusMap() {
  ...
  $.ajax({
      type: "GET",
      url: "php/admin_fair_content_aricle_add.php?method=chgstatusmap&status="+st,
      dataType: "text",
      success : function(data) {
        $('.sm_').empty();
        $('.sm_').html(data);
