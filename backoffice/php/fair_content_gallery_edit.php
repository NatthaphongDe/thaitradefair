<?php
$save_link = "fair_content_gallery_edit";
...
function changeStatus() {
  ...
  $.ajax({
      type: "GET",
      url: "php/fair_content_gallery_edit.php?method=chgstatus&status="+st,
      dataType: "text",
...
function changePublish() {
  ...
  $.ajax({
      type: "GET",
      url: "php/fair_content_gallery_edit.php?method=chgpublish&status="+st,
      dataType: "text",
      success : function(data) {
        $('._pp').empty();
        $('._pp').html(data);
...
function removeFileAction(id) {
  $.ajax({
      type: "GET",
      url: "php/fair_content_gallery_edit.php?method=delete&id="+id,
      dataType: "text",
      success : function(data) {
