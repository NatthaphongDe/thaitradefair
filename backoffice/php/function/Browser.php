...
/*
	$browser = new Browser();
	echo $sql_log = "insert into eat_login (time_log,member_id,ip,browser,os) values(now(),'1','".$_SERVER['REMOTE_ADDR']."','".$browser->getBrowser().$browser->getVersion()."','".$browser->getPlatform()."')";
	*/
