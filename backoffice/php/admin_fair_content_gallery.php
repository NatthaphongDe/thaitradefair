...
$save_link = "admin_fair_content_gallery";
       ...
       <ol class="breadcrumb">
           <li>
            ...
            <div class="div-right text-right">
              <a href="home.php?show=admin_fair_content_gallery_add&fair_id=<?=$fair_id?>&fct_id=<?=$fct_id?>" class="btn btn-success">+ Add <?=$menu_head?></a>
                        ...
                        while($data = $result->fetch_assoc()) {
                          ...
                          <tr>
                            ...
                            <td class="text-center vmiddle">
                              ...
                              <span><img id="e_<?=$data["fcg_id"]?>" onmouseover="actionOver('e_<?=$data["fcg_id"]?>','1');" onmouseout="actionOut('e_<?=$data["fcg_id"]?>','1')" src="../backoffice/asset/icon_edit_null.png" height="35" onclick="window.location='home.php?show=admin_fair_content_gallery_edit&id=<?=$data["fcg_id"]?>&fair_id=<?=$data["fair_id"]?>&fct_id=<?=$data["fct_id"]?>';" ></span>
                              &nbsp;
...
function changeStatus(id,type) {
  $.ajax({
      type: "GET",
      url: "php/admin_fair_content_gallery.php?method=chgstatus&id="+id+"&status="+type,
      dataType: "text",
...
function confirmDeleteAction(id) {
  $.ajax({
      type: "GET",
      url: "php/admin_fair_content_gallery.php?method=delete&id="+id+'&fair_id=<?=$fair_id?>&fct_id=<?=$fct_id?>',
      dataType: "text",
      success : function(data) {
