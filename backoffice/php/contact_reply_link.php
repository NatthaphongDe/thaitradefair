              ...
              <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="list-group-item">
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="input-group">
                          ...
                          <input id="msg" name="reply_subject" type="text" class="form-control" name="msg" placeholder="Input Title?">
                        </div>
                      </div>
                      <div class="col-sm-4" style="text-align:right">
                    ...
                    <textarea name="reply_mesage" class="tinyclass"></textarea>
                  </div>
                  <!--  -->
