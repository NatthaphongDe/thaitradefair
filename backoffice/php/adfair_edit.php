...
if($_REQUEST["method"]=="add") {
  ...
  if($stmt) {
    $stmt->bind_param('sissssssssiiissssi',$fair_name,$fair_year,$fair_trade_start,$fair_trade_end,$fair_public_start,$fair_public_end,$fair_event_start,$fair_event_end,$fair_vanue,$fair_url,$fair_status,$adminid,$fair_map_status,$fair_map_title,$fair_lat,$fair_lng,$fait_map_address,$fair_id);
    $stmt->execute();
                ...
                <div class="row">
                  <div class="col-xs-4 col-lg-4">
                    <div class="form-group">
                      ...
                      <div class="col-lg-12">
                        <input type="text" class="form-control" name="fair_vanue" value="<?=$data["fair_name"]?>"  />
                      </div>
                    </div>
                  </div>
...
function changeStatus() {
  ...
  $.ajax({
      type: "GET",
      url: "php/adfair_edit.php?method=chgstatus&status="+st,
      dataType: "text",
...
function changeStatusMap() {
  ...
  $.ajax({
      type: "GET",
      url: "php/adfair_edit.php?method=chgstatusmap&status="+st,
      dataType: "text",
      success : function(data) {
        $('.sm_').empty();
        $('.sm_').html(data);
