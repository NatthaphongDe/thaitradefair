<?php
$save_link = "fair_content_aricle_edit";
...
if($stmt) {
  ...
  if($numrow>0) {
    ...
    if($data["ref_content_img"]=="") {
      $sqlup = " update tt_fair_content_article set
               ref_content_img = ?
               where fca_id = ? ";
      $stmtup = $mysqli->prepare($sqlup);
...
function changeStatus() {
  ...
  $.ajax({
      type: "GET",
      url: "php/fair_content_aricle_edit.php?method=chgstatus&status="+st,
      dataType: "text",
...
function changePublish() {
  ...
  $.ajax({
      type: "GET",
      url: "php/fair_content_aricle_edit.php?method=chgpublish&status="+st,
      dataType: "text",
      success : function(data) {
        $('._pp').empty();
        $('._pp').html(data);
...
function changeStatusMap() {
  ...
  $.ajax({
      type: "GET",
      url: "php/fair_content_aricle_edit.php?method=chgstatusmap&status="+st,
      dataType: "text",
      success : function(data) {
        $('.sm_').empty();
        $('.sm_').html(data);
