...
if($_REQUEST["method"]=="add") {
  ...
  <script type="text/javascript">
    ...
    setTimeout(function () {top.window.location="../home.php?show=admin_fair_content_portal&fair_id=<?=$fair_id?>&fct_id=<?=$fct_id?>";},500);
  </script>
  <?php
  exit();
...
$save_link = "admin_fair_content_onepage";
?>
...
function changeStatus() {
  ...
  $.ajax({
      type: "GET",
      url: "php/admin_fair_content_onepage.php?method=chgstatus&status="+st,
      dataType: "text",
...
function changeStatusMap() {
  ...
  $.ajax({
      type: "GET",
      url: "php/admin_fair_content_onepage.php?method=chgstatusmap&status="+st,
      dataType: "text",
      success : function(data) {
        $('.sm_').empty();
        $('.sm_').html(data);
...
function changeTypeCMSAction(id) {
  $.ajax({
      type: "GET",
      url: "php/admin_fair_content_onepage.php?method=chnagetpye&type="+id+'&fair_id=<?=$fair_id?>&fct_id=<?=$fct_id?>',
      dataType: "text",
      success : function(data) {
...
function changePublish() {
  ...
  $.ajax({
      type: "GET",
      url: "php/admin_fair_content_onepage.php?method=chgpublish&status="+st,
      dataType: "text",
      success : function(data) {
        $('._pp').empty();
        $('._pp').html(data);
