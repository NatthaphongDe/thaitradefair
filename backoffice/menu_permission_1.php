...
<li class="active">
  ...
  <ul class="nav nav-second-level">
        ...
        <li <?php if($_REQUEST['show']=="fair_list" or $_REQUEST['show']=="fair_add" or $_REQUEST['show']=="fair_edit" or $_REQUEST['show']=="fair_information" or $_REQUEST['show']=="fair_menu_list" or $_REQUEST['show']=="fair_cover" or $_REQUEST['show']=="fair_cover_add" or $_REQUEST['show']=="fair_cover_edit" or $_REQUEST['show']=="fair_token"){echo "class='active'";}?>><a href="home.php?show=fair_list">• Fair Manager</a></li>
        <? } ?>
...
<li class="active">
  ...
  <ul class="nav nav-second-level">
        ...
        <? if(getRolePageMenu($datarr["role_id"],19)==1) { ?>
          <li  <?php if($_REQUEST['show']=="admin_report" ){echo "class='active'";}?>><a href="home.php?show=admin_report">• Admin Activity Report</a></li>
        <? } ?>

        <? if(getRolePageMenu($datarr["role_id"],20)==1) { ?>
          <li  <?php if($_REQUEST['show']=="sso_report" ){echo "class='active'";}?>><a href="home.php?show=sso_report">• User SSO Report</a></li>
        <? } ?>
