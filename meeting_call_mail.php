...
// การดึงค่ามาใช้งาน (ใช้ได้ 2 วิธี)
// $meeting_id = 7;
/* print_r(555);
$value ='natthaphong.d@ibusiness.co.th';
$message = 'test';
$To_Name ='team';
$body = [
    "sender" => [
            ...
            <div class="b3" style="background-image: url(<?php echo ROOTPATHDOMAIN; ?>assets/images/mail-b-banner-bg.png);background-repeat: no-repeat; background-position: bottom;background-size: contain;">
              <div class="b4" style="background-image: url(<?php echo ROOTPATHDOMAIN; ?>assets/images/mail-b-3.png);background-repeat: no-repeat;background-position: right bottom;background-size: auto 400px;">
                <div class="" style="padding:40px 50px 15px 50px;text-align: left">
                  ...
                  <?php if ($dataeld['meeting_message'] != '') { ?>
                    <div style="margin-bottom: 15px;">
                      Message : <?php echo $dataeld['meeting_message']; ?>
                    </div>
                  <?php } ?>
                  <div style="text-align: center">
                    <a style=" width: 222px; padding: 7px 21px 6px 22px; border-radius: 8px;  background-color: #e91a1a;color: #fff; text-decoration: inherit;" href="<?php echo ROOTPATHDOMAIN . "meeting_confirm.php?token=" . $meeting_token; ?>&check=cancel">Cancel Meeting</a>
                  </div>
